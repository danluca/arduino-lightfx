    ...
    <main>
        ...
        <section id="status">
            ...
            <dl id="statusArea">
                ...
                <dd>Temperature: <span id="boardTemp"></span> <br/><span class="indent2">[<span id="boardMinTemp"></span> - <span id="boardMaxTemp"></span>] °C</span></dd>
                <dd>Vcc: <span id="boardVcc"></span> <br/><span class="indent2">[<span id="boardMinVcc"></span> - <span id="boardMaxVcc"></span>] V</span></dd>
