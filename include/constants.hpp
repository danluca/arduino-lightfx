...
inline constexpr auto csIgnoreWebFx PROGMEM = "ignoreWebFx";
inline constexpr auto kHeaderXSource PROGMEM = "X-Source";  // HTTP header constants for origin discrimination
inline constexpr auto kXSourceUi PROGMEM = "ui";
inline constexpr auto kXSourceBoard PROGMEM = "board";
inline constexpr auto kHeaderUserAgent PROGMEM = "User-Agent";
inline constexpr auto kUaBoardPrefix PROGMEM = "rp2040-lightfx-master";     // User-Agent prefix used by board-originated sync/broadcast requests
...
inline constexpr auto csFxTask PROGMEM = "Fx";
