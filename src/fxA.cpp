...
constexpr char fxa1Desc[] PROGMEM = "FXA1: Multiple Tetris segments";
constexpr char fxa2Desc[] PROGMEM = "FXA2: Randomly sized and spaced segments moving on entire strip";
constexpr char fxa3Desc[] PROGMEM = "FXA3: Moving variable dot size back and forth";
constexpr char fxa4Desc[] PROGMEM = "FXA4: pixel segments moving opposite directions";
constexpr char fxa5Desc[] PROGMEM = "FXA5: Moving a color swath on top of another";
constexpr char fxa6Desc[] PROGMEM = "FXA6: Sleep Light";
