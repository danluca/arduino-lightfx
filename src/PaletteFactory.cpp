 ...
 */
constexpr TProgmemRGBPalette16 HalloweenColors_p FL_PROGMEM = {
...
constexpr TProgmemRGBPalette16 HalloweenStripeColors_p FL_PROGMEM = {
 ...
 */
constexpr TProgmemRGBPalette16 ChristmasColors_p FL_PROGMEM = {
 ...
 */
constexpr TProgmemPalette16 PartierColors_p FL_PROGMEM = {
...
constexpr TProgmemPalette16 PartierColorsCompl_p FL_PROGMEM = {
...
constexpr TProgmemPalette16 PatrioticColors_p FL_PROGMEM = {
        CRGB::DarkRed, CRGB::DarkRed, CRGB::Red, CRGB::Red,
        CRGB::Gray, CRGB::Gray, CRGB::White, CRGB::White,
...
constexpr TProgmemPalette16 ValentineColors_p FL_PROGMEM = {
        CRGB::DarkRed, CRGB::DarkRed, CRGB::Red, CRGB::Red,
...
constexpr TProgmemPalette16 PatrickColors_p FL_PROGMEM = {
        CRGB::DarkGreen, CRGB::DarkGreen, CRGB::Green, CRGB::Green,
...
constexpr TProgmemPalette16 SleepyColors_p FL_PROGMEM = {
...
constexpr TProgmemPalette16 RedGreenWhite_p FL_PROGMEM = {
...
constexpr TProgmemPalette16 FairyLight_p FL_PROGMEM = {
...
constexpr TProgmemPalette16 Snow_p FL_PROGMEM = {
...
constexpr TProgmemPalette16 RetroC9_p FL_PROGMEM = {
...
constexpr TProgmemRGBPalette16 Ice_p FL_PROGMEM = {
...
void holidayUpdate() {
    ...
    if (const Holiday hDay = paletteFactory.adjustHoliday(); oldHday == hDay)
