...
constexpr char fxb1Desc[] PROGMEM = "FXB1: rainbow";
constexpr char fxb2Desc[] PROGMEM = "FXB2: rainbow with glitter";
constexpr char fxb3Desc[] PROGMEM = "FXB3: confetti B";
constexpr char fxb4Desc[] PROGMEM = "FXB4: sinelon";
constexpr char fxb5Desc[] PROGMEM = "FXB5: juggle short segments";
constexpr char fxb6Desc[] PROGMEM = "FXB6: bpm";
constexpr char fxb7Desc[] PROGMEM = "FXB7: ease";
constexpr char fxb8Desc[] PROGMEM = "FXB8: fadein";
constexpr char fxb9Desc[] PROGMEM = "FXB9: juggle long segments";
